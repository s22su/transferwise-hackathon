...
<div class="container">
	<div class="row">
		...
		<div class="col-md-3">
			<p class="lead">Domino's (Windsor, UK)</p>
			<div class="list-group">
				<a href="#" class="list-group-item">Pizzas</a>
				<a href="#" class="list-group-item">Cakes</a>
		...
		<div class="col-md-9">
				...
				<div class="col-md-12">
					<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							...
							<div class="item">
								<img class="slide-image" src="img/pizza/13.jpg" alt="">
							</div>
						</div>
			...
			<div class="row">
				<div class="col-sm-4 col-lg-4 col-md-4">
					<div class="thumbnail">
						<img src="img/pizza/4.jpg" alt="">
						<div class="caption">
							<h4 class="pull-right">$13.99</h4>
							<h4><a href="#">Barbecue</a>
							</h4>
							<p>This is a short description. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
						</div>
						<div class="ratings">
