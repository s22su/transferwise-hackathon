...
?>
    ...
    <section class="no-padding" id="sell">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    ...
                    <hr class="primary">
                    <p>Have a specific order for your loved ones abroad? Send us a message and we will try to find a way to reach them.</p>
                </div>
                ...
                <div class="col-lg-4 text-center">
                    ...
                    <p><a href="mailto:hello@giftime.com">hello@giftime.com</a></p>
                </div>
            </div>
        </div>
    </section>